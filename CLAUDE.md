...
- リバランス閾値: **0.15** (2026-04-21: 0.20 から変更 / IS CAGR +0.5pp)
- 期待CAGR (1974-2026): +30.30%+ (旧 Approach B: +24.46% から +5.84pp+ 改善)
- 変更記録: [docs/THRESHOLD_CHANGE_2026-04-21.md](docs/THRESHOLD_CHANGE_2026-04-21.md) / [docs/APPROACH_A_MIGRATION_2026-04-20.md](docs/APPROACH_A_MIGRATION_2026-04-20.md)
